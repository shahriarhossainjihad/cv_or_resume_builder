...
<html lang="en">
  ...
  <body>
    <div class="container my-4 p-4 shadow">
        <h2><a style="text-decoration: none;" href="index.php">Update Party/Ledger information</a></h2>
        <form class="form" action="" method="post" enctype="multipart/form-data">
        <?php if(isset($msg)){echo $msg;} ?>
            <input class="form-control mb-2" type="text" name="u_std_name" value="<?php echo $returndata['std_name']; ?>">
            <input class="form-control mb-2" type="text" name="u_sub_name" value="<?php echo $returndata['sub_name']; ?>">
            <label for="image">Change Profile Picture</label>
            <input class="form-control mb-2" type="file" name="u_std_img" <?php echo $returndata['stg_img']; ?>>
